...
const banner_list = ref([
    '/imgs/down-banner-1.jpg',
    '/imgs/down-banner-2.jpg',
    '/imgs/down-banner-3.jpg',
    '/imgs/down-banner-4.jpg',
])
const comment_list = ref([
    {
        name: 'Lara Liras', 
        avatar: '/imgs/down-avatar-1.webp', 
    ...
    },
    {
        ...
        avatar: '/imgs/down-avatar-2.webp', 
    ...
    },
    {
        ...
        avatar: '/imgs/down-avatar-3.webp', 
...
async function confirmSuccess() {
    if (deferredPrompt.value) {
        ...
        if(outcome == 'accepted') {
            window.location.href = window.pwaurl
        }
    }
}
function reload() {
...
<template>
    <!-- style="--color-theme: #01875F;--color-rgbawhite50: #5F6367;" -->
    <div class="w-full h-full bg-themewhite relative flex flex-col z-[999]" >
        <header :style="`padding-top: ${top};`" class="w-full shrink-0">
            <div class="w-full h-[3.25rem] pl-5 pr-3 flex items-center justify-between">
                <img src="/imgs/down-google.png" class="w-auto h-9">
                <img src="/imgs/down-devel.png" class="w-auto h-9">
            </div>
        </header>
        <section class="w-full flex-1 overflow-y-auto">
            <pu-card theme="3" class="pt-10 pb-3">
                <dl class="flex items-center">
                    <dt class="mr-6 shrink-0">
                        <van-image src="/icons/appicon.png" width="4.5rem" height="4.5rem" radius="1rem" fit="cover" style="box-shadow: 0 1px 2px 0 rgba(60,64,67,.3),0 1px 3px 1px rgba(60,64,67,.15);" />
                    </dt>
                    <dd class="flex-1 overflow-hidden">
                        <h5 class="text-[1.5625rem] font-bold">
                            <span>{{ window.document.title }}</span>
                        </h5>
                        <p class="text-base text-themetext font-medium">
                            <span>{{ window.document.title }} LTD CO.</span>
                        </p>
                        <p class="text-xs text-rgbawhite50">
            ...
            <pu-card theme="4" class="py-3">
                <dl class="w-full text-center flex">
                    <dd class="w-1/3 px-2 relative flex flex-col items-center">
                        <h6 class="text-sm text-[#202124] !leading-6 font-medium">
                    ...
                    <dd class="w-1/3 px-2 relative flex flex-col items-center">
                        <div class="py-1 flex">
                            <img src="/imgs/down-time.webp" class="w-4 h-4">
                        </div>
                        <p class="text-xs text-rgbawhite50">
            ...
            <pu-card theme="3" class="pt-8 pb-2">
                <a @click="checkIsInstall()" href="javascript:;" class="w-full h-14 bg-theme text-themewhite rounded-lg relative block overflow-hidden">
            ...
            <pu-card theme="3" class="py-3">
                <dl class="w-full text-[0.9375rem] !leading-none text-themetext flex">
                ...
                <div class="w-full h-[14rem] overflow-hidden">
                    <div class="w-full h-[14.5rem] overflow-x-auto">
                        <ul class="flex flex-nowrap">
                            <li v-for="item,index in banner_list" :key="index" class="mr-3 flex shrink-0">
            ...
            <pu-card theme="3" class="py-3">
                <div class="w-full mb-5 flex items-center">
                    ...
                    <svg class="w-5 h-5 text-rgbawhite50 shrink-0" stroke="currentColor" stroke-width="4" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <article class="text-sm text-rgbawhite50">
                    <p>Sobre este jogo * The Hottest Casino Slots Game of 2024 * The ring of the reels, lights on the screen, and the thrill of the win! Casino Slots bring the spectacle of Las Vegas and Macau casino slots to your fingertips! It also brings the sights and sounds of the casino experience home and stack your winnings to the sky! The more you spin, the more you win!</p>
                </article>
                <div class="mt-6">
                    <h6 class="text-sm font-medium">Atualizado em</h6>
                    <p class="text-sm text-rgbawhite50">10 de fev. de 2025</p>
                </div>
            ...
            <pu-card theme="3" class="py-3">
                ...
                <article class="text-sm text-rgbawhite50">
                    ...
                    <div class="w-full p-5 mt-8 border border-[#DADCE0]">
                        ...
                        <div class="pl-2.5 mt-5">
                            <p class="text-sm text-themetext">Mais detalhes</p>
                        </div>
                    </div>
                </article>
            </pu-card>
            <pu-card theme="3" class="py-3">
                ...
                <ul class="w-full !mt-5 !mb-1 text-sm text-rgbawhite50 flex flex-wrap">
                    <li class="h-8 px-4 my-1.5 mr-3 text-themetext bg-[#e6f3ef] rounded-full flex items-center shrink-0">
                ...
                <dl class="pt-3 mb-4 flex">
                    <dt class="w-2/5 pr-2">
                        ...
                        <div class="flex">
                            <svg v-for="item,index in 5" :key="index" class="w-3.5 h-3.5 mr-1.5 text-themetext" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                                <path d="M12.0006 18.26L4.94715 22.2082L6.52248 14.2799L0.587891 8.7918L8.61493 7.84006L12.0006 0.5L15.3862 7.84006L23.4132 8.7918L17.4787 14.2799L19.054 22.2082L12.0006 18.26Z"></path>
                            </svg>
                        </div>
                        <p class="mt-1 text-sm text-rgbawhite50 font-light">1,91 mil avaliações</p>
                    </dt>
                    <dd class="w-3/5 pl-2">
                        <ol class="!pt-1 text-xs text-rgbawhite50">
                            <li class="w-full h-4 mb-1 flex items-center">
                                <div class="w-6 shrink-0">5</div>
                                <div class="flex-1 overflow-hidden">
                                    <em class="w-full h-2.5 bg-[#E8EAED] rounded-full flex">
                                        <i style="width: 92.644%;" class="h-full bg-theme rounded-full flex"></i>
                                    </em>
                                </div>
                            </li>
                            <li class="w-full h-4 mb-1 flex items-center">
                                ...
                                <div class="flex-1 overflow-hidden">
                                    <em class="w-full h-2.5 bg-[#E8EAED] rounded-full flex">
                                        <i style="width: 6.5445%;" class="h-full bg-theme rounded-full flex"></i>
                                    </em>
                                </div>
                            </li>
                            <li class="w-full h-4 mb-1 flex items-center">
                            ...
                            <li class="w-full h-4 mb-1 flex items-center">
                                ...
                                <div class="flex-1 overflow-hidden">
                                    <em class="w-full h-2.5 bg-[#E8EAED] rounded-full flex">
                                        <i style="width: 2.46073%;" class="h-full bg-theme rounded-full flex"></i>
                                    </em>
                                </div>
                            </li>
                            <li class="w-full h-4 mb-1 flex items-center">
                    ...
                    <template v-for="item,index in comment_list" :key="index">
                        <li class="w-full py-4 block">
                            <div class="flex items-center">
                                ...
                                <div class="flex-1 overflow-hidden">
                                    <h6 class="text-sm text-rgbawhite50 font-light">
                                        <span>{{ item.name }}</span>
                                    </h6>
                                </div>
                            ...
                            <div class="mt-4 flex items-center">
                                <svg v-for="item,index in 5" :key="index" class="w-2.5 h-2.5 mr-1 text-themetext" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                                    <path d="M12.0006 18.26L4.94715 22.2082L6.52248 14.2799L0.587891 8.7918L8.61493 7.84006L12.0006 0.5L15.3862 7.84006L23.4132 8.7918L17.4787 14.2799L19.054 22.2082L12.0006 18.26Z"></path>
                                </svg>
                                <span class="ml-2 text-xs text-rgbawhite50">{{ item.date }}</span>
                            </div>
                            <article class="mt-2 text-sm text-rgbawhite50">
                                <p>{{ item.content }}</p>
                            </article>
                            <p class="mt-4 text-xs text-rgbawhite50">
                                <span>Essa avaliação foi marcada como útil por 20 pessoas</span>
                            </p>
                            <div class="mt-3 flex items-center flex-wrap">
                                <p class="mr-5 text-xs text-rgbawhite50">
                                    <span>Você achou isso útil?</span>
                                </p>
                                <a href="javascript:;" class="h-[1.375rem] px-4 my-1.5 mr-3 border border-[#DADCE0] rounded-full flex items-center shrink-0">
                                    <span class="text-sm text-rgbawhite50 opacity-70">Sim</span>
                                </a>
                                <a href="javascript:;" class="h-[1.375rem] px-4 my-1.5 mr-3 border border-[#DADCE0] rounded-full flex items-center shrink-0">
                                    <span class="text-sm text-rgbawhite50 opacity-70">Não</span>
                                </a>
                            </div>
                        </li>
                    </template>
                </ul>
                <button class="h-12 px-2 !text-sm !text-themetext !font-medium bg-transparent">
        ...
        <footer :style="`padding-bottom: ${bottom};`" class="w-full bg-themewhite text-[#5F6368] border-t border-[rgb(218,220,224)] block shrink-0">
            <nav class="w-full h-[56px] flex justify-between">
                ...
                <a @click="checkIsInstall()" href="javascript:;" class="w-1/5 h-full text-themetext flex flex-col items-center justify-center">
                    <div class="h-[24px]">
        ...
        >
            <section v-if="ios_guide_show" class="w-full h-full px-ctx py-6">
                <div class="w-full relative">
                    <img src="/imgs/down-ios-guide.png" class="w-full h-auto block">
        ...
        <section v-if="pwa_loading_show" class="w-full h-full bg-rgbablack50 absolute left-0 top-0 z-30 flex items-center justify-center">
            <div class="w-[19.375rem] px-[24px] py-[32px] bg-themewhite text-themeblack rounded-xl">
                <div class="w-full mb-[10px] flex items-center justify-center">
                    <img src="/imgs/down-paw-install.png" class="w-[28px] h-auto mr-[8px]">
                    <h5 class="text-[27px] text-[#666] !leading-[33px]">Rapid Instalar</h5>
                </div>
                <div v-if="pwa_success_show" class="w-full py-[8px] flex flex-col items-center">
                    <div class="px-[20px] py-[4px] mb-[24px] bg-[#D9FECD] text-themetext rounded-full flex items-center">
                    ...
                    <a @click="confirmSuccess()" href="javascript:;" class="w-full h-[44px] bg-theme text-themewhite rounded-full flex items-center justify-center">
                        <span class="text-[16px] font-medium">Instalar Agora</span>
                    </a>
                </div>
                ...
                <div v-else class="w-full py-[8px] flex items-center justify-center">
                    <div class="w-[100px] h-[100px] relative">
                        ...
                        <div class="w-full h-full absolute left-0 top-0 flex items-center justify-center">
                            <span class="text-[16px] text-themetext font-semibold">{{ counter }}%</span>
                        </div>
                    </div>
                </div>
            </div>
