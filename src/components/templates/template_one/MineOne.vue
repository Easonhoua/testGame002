            ...
            <dl class="flex">
                ...
                <dd class="pl-5 flex-1 overflow-hidden">
                    ...
                    <p class="mb-0.5 text-right">
                        ...
                        <b class="text-sm text-one">{{ currentUnit.value }}&nbsp;{{ fn(memberRef.account&&memberRef.account.user_money||0 )}}</b>
                    </p>
                    <!-- 每日奖励 -->
                    <p class="mb-0.5 text-right">
                        <span class="text-xs opacity-85">Total de bônus recebidos:&nbsp;</span>
                        <b class="text-sm text-one">{{ currentUnit.value }}&nbsp;{{ fn(memberRef.give_amount||0 )}}</b>
                    </p>
