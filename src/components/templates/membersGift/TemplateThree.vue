...
<template>
  <pu-card theme="3" class="relative">
    <section class="w-full p-px mt-4 mb-6">
      <div class="w-full relative  h-[2.6rem]  bg-searchbg  rounded-full border border-themetext2 flex items-center justify-center px-2 text-themetext1">
    ...
    <section class="w-full p-px my-4 h-[5.2rem] bg-gradient-to-r from-minelinear1 to-minelinear2 rounded-lg flex flex-col px-2">
    ...
    <section class="w-full h-[2rem] p-px mb-8 mt-14 ">
      <div class="w-full flex h-[2.4rem] rounded-full items-center justify-center  m3-theme-btn1 font-bold cursor-pointer"
